...
5. **哔哩哔哩高码率 (`BILIBILI_COOKIE`)**：
   * 用于提取 1080P 高码率/4K 及大会员专享番剧正片。推荐精简 Cookie 配置 `SESSDATA=xxx; bili_jct=yyy;`。未配置时仍可完全免登录获取 720P/1080P 官方基础流与音频。
6. **拼多多多多视频 (`PINDUODUO_COOKIE`)**：
